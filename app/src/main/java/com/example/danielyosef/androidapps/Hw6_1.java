...
public class Hw6_1 extends View{
    ...
    public Hw6_1(Context context) {
        super(context);
        init();
    }

    public Hw6_1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Hw6_1(Context context, AttributeSet attrs, int defStyleAttr) {
